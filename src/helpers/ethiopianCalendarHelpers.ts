...
export function gregorianToEthiopian(gregorianDate: Date): EthiopianDate {
  const [ethiopianYear, ethiopianMonth, ethiopianDate] = toEthiopian(gregorianDate.getFullYear(), gregorianDate.getMonth(), gregorianDate.getDate())
...
export function ethiopianToGregorian(ethDate: EthiopianDate): Date {
    ...
    let [year, month, day] = toGregorian(ethDate.year, ethDate.month, ethDate.day)
