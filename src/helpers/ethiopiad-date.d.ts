declare module 'ethiopian-date' {
  ...
  export function toEthiopian(year: number, month: number, day: number): EthiopianDateArray;
  
  export function toGregorian(ethiopianYear: number, ethiopianMonth: number, ethiopianDay: number): number[];
